...
// Assign variable for a while looping condition
let condition = true;
while (condition) {
    ...
    console.log(chalk.yellow("\n\n\n\t\t------------------------ focus2learn-------------------------"));
    // get input to re-enter new sentence
    const repeat = await inquirer.prompt({
        name: "domore",
        type: "confirm",
        message: chalk.rgb(100, 200, 20)("\n\t\tDo you want to type new sentence....."),
        default: false,
    });
    condition = repeat.domore;
}
